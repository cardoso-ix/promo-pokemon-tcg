...
| --- | --- |
| 2026-09-02 | Foto + nome da réplica (Decisão 52): polycard, `url_foto_html`, injeção de `titulo_produto` na legenda. Painel (Decisão 53): Config grava a lista branca; `tools/publicar-painel.py`; login em `painel/replica-login.html`; SQL vivo em `sql/` (`canais_no_chat` + `titulo`). HTML vigente: 50649 / `pagina_gz` 67532. |
