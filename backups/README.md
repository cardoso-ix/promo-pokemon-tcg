...
| --- | --- |
| 2026-09-02 | Foto + nome da réplica (Decisão 52). Painel editável (53). Só Mercado Livre (54). Script `tools/publicar-painel.py` + `tools/publicar-ingest-n8n.py`. Login em `painel/replica-login.html`. SQL vivo em `sql/`. HTML vigente: 53069 / `pagina_gz` 70760. Mapa: `docs/retomar-hoje.md`. |
