...
| `Replica WhatsApp Ingest` | `4mE343XrNXgIwAIF` | **Ativo** | Foto do polycard do encurtador, não da página `/p/` ([Decisão 52](historico-de-decisoes.md#decisão-52--foto-oficial-do-anúncio-mesmo-quando-a-origem-veio-só-com-texto)). Conferir `versionId` = `activeVersionId` depois do PUT. |
