...
| `Replica WhatsApp Ingest` | `4mE343XrNXgIwAIF` | **Ativo** | Sim, `d90d6d88` — foto oficial do anúncio no ML mesmo quando a origem veio só com texto ([Decisão 52](historico-de-decisoes.md#decisão-52--foto-oficial-do-anúncio-mesmo-quando-a-origem-veio-só-com-texto)) |
...
sai no destino mesmo quando a origem veio só com texto
