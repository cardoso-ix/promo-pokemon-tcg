...
| **Replica WhatsApp Ingest** | **Ativo** — rota TCG Promo; foto do polycard do encurtador ([Decisão 52](docs/historico-de-decisoes.md#decisão-52--foto-oficial-do-anúncio-mesmo-quando-a-origem-veio-só-com-texto)), publicado `c16c7118` |
